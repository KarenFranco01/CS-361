...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints PART TIME EMPLOYEE because emp3 = pEmp1 and pEmp1 is a part time employee
		// emp3.getHourlyRate(); // returns syntax error because getHourlyRate() has not yet been defined so it would not return anything
		...
		// because the class employee.Employee is improperly cast to employee.PartTimeEmployee
